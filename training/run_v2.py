...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(
        dataset=train_dataset, batch_size=142, shuffle=True, num_workers=4
    )

    val_loader = DataLoader(dataset=val_dataset, batch_size=142, num_workers=4)

    test_loader = DataLoader(dataset=test_dataset, batch_size=142, num_workers=4)
